...
public class CreateDatasetRunItemRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(runName, datasetItemId, observationId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateDatasetRunItemRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateDatasetRunItemRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
