...
public class IngestionBatchRequest {
  ...
  public IngestionBatchRequest batch(List<Object> batch) {
  ...
  public IngestionBatchRequest addBatchItem(Object batchItem) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(batch, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to IngestionBatchRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IngestionBatchRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("batch") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("batch").isJsonArray()) {
