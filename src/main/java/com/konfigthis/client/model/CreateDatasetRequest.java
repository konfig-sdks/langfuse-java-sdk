...
public class CreateDatasetRequest {
  ...
  **/
   ...
   * @return the CreateDatasetRequest instance itself
   */
  public CreateDatasetRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createDatasetRequest.name)&&
        Objects.equals(this.additionalProperties, createDatasetRequest.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateDatasetRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateDatasetRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateDatasetRequest>() {
           ...
           public CreateDatasetRequest read(JsonReader in) throws IOException {
             ...
             CreateDatasetRequest instance = thisAdapter.fromJsonTree(jsonObj);
