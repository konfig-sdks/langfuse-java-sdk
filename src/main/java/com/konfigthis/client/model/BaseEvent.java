...
public class BaseEvent {
  ...
  **/
  ...
  public BaseEvent metadata(Object metadata) {
  ...
  **/
   ...
   * @return the BaseEvent instance itself
   */
  public BaseEvent putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, baseEvent.id) &&
        Objects.equals(this.timestamp, baseEvent.timestamp) &&
        Objects.equals(this.metadata, baseEvent.metadata)&&
        Objects.equals(this.additionalProperties, baseEvent.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, timestamp, metadata, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BaseEvent
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BaseEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : BaseEvent.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BaseEvent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BaseEvent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BaseEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BaseEvent.class));
       ...
       return (TypeAdapter<T>) new TypeAdapter<BaseEvent>() {
           ...
           public BaseEvent read(JsonReader in) throws IOException {
             ...
             BaseEvent instance = thisAdapter.fromJsonTree(jsonObj);
