 ...
 */
@ApiModel(description = "Daily usage of a given model. Usage corresponds to the unit set for the specific model (e.g. tokens).")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class UsageByModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(model, inputUsage, outputUsage, totalUsage, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UsageByModel
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UsageByModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
